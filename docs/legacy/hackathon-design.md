# Charter — 黑客松项目文档 (legacy)

> **Historical reference only.** This is the original hackathon design doc
> from 2026-05-17, kept as-is for posterity. It mixes protocol spec,
> design rationale, demo scripts, slides, sound bites, and competitive
